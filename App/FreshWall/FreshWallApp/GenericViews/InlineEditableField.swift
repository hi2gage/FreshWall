...
// MARK: - InlineEditableField

struct InlineEditableField<Value>: View {
    let title: String
    let value: Value?
...
extension InlineEditableField where Value == Double {
    init(
        title: String,
        value: Double?,
        placeholder: String = "",
...
extension InlineEditableField where Value == String {
    init(
        title: String,
        value: String?,
        placeholder: String = "",
