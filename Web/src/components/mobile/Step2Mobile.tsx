      ...
      <div className="container mx-auto px-4">
        <div className="text-center space-y-4">
          <div>
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-2">Track automatically</h3>
            <p className="text-sm text-gray-600 px-4">Job data, timestamps, and materials are organized for you.</p>
          </div>
