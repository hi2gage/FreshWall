    ...
    <section className="bg-gradient-to-br from-blue-50 to-indigo-100 min-h-screen flex items-center justify-center">
      <div className="container mx-auto px-6 text-center">
        ...
        <div className="space-x-4">
          <a href="mailto:gage@freshwall.app?subject=Demo Request" className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-8 rounded-lg text-lg transition-colors inline-block">
            Request a Demo
          </a>
        </div>
        <div className="mt-8 text-gray-600">
          <p>gage@freshwall.app</p>
        </div>
      </div>
    </section>
  )
