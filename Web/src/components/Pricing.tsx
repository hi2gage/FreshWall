        ...
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="max-w-md mx-auto bg-white rounded-2xl p-8 border-2 border-gray-300">
            <div className="mb-6">
              ...
              <div className="text-4xl font-bold text-brand-600 mb-2">$99<span className="text-lg text-gray-600">/month</span></div>
            ...
            <a
              href="/demo"
              className="w-full bg-brand-600 hover:bg-brand-700 text-white font-bold py-3 px-6 rounded-lg text-lg transition-colors inline-block text-center"
            >
              Request a Demo
            </a>
          </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-6 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <cite className="text-lg text-brand-600 font-semibold">Montana Graffiti Removal Co.</cite>
          </div>
        </div>
      </section>
