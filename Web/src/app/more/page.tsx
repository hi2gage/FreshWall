...
export default function MorePage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-b from-blue-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center">
            ...
            {/* Mobile app callout */}
            <div className="bg-blue-100 border border-blue-200 rounded-lg p-4 max-w-md mx-auto mb-8">
              <div className="flex items-center justify-center space-x-2">
                <svg className="w-6 h-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" />
                </svg>
                <span className="text-blue-800 font-medium">
                  After signing up, return to your iOS app to get started!
                </span>
              </div>
            </div>
          </div>
      ...
      {/* Pricing Section - What iOS app can't show */}
        ...
        <div className="mt-16 text-center">
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-8 max-w-2xl mx-auto">
            ...
            <p className="text-gray-600 mb-6">
              After creating your account, return to the FreshWall iOS app to start tracking incidents and collaborating with your team.
            </p>
            ...
            >
              ...
              <span>Return to FreshWall App</span>
            </a>

            <p className="text-sm text-gray-500 mt-4">
              If the button doesn't work, manually open the FreshWall app on your device
            </p>
          </div>
        </div>
      </div>
